...
class StatusTest extends TestCase
{
    ...
    public function testConnections()
    {
        ...
        $this->assertSame('2017-06-30 08:13:30', $connection->connectedAt()->format(Format::of('Y-m-d H:i:s')));
    ...
    public function testChannels()
    {
        ...
        $this->assertSame('2017-06-30 08:13:31', $channel->idleSince()->match(
            static fn($point) => $point->format(Format::of('Y-m-d H:i:s')),
            static fn() => null,
        ));
    }
